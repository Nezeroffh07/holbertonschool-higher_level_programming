...
app.config['JWT_SECRET_KEY'] = 'jwt_secret_key_example'

auth = HTTPBasicAuth()
jwt = JWTManager(app)

# İstifadəçi bazası (in-memory)
users = {
    "user1": {
        "username": "user1",
...
# --- JWT Xəta Handler-ləri (401 Unauthorized tələbi üçün) ---
...
def login():
    ...
    if user and check_password_hash(user["password"], password):
        # Rol məlumatını tokenin içinə (claims) yerləşdiririk
